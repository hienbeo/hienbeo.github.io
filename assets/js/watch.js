$(document).ready(function() {
  ...
  let serverRoot =
    "https://cors-anywhere.herokuapp.com/http://canbo.vinhuni.edu.vn";
...
$(".change-pixel").click(function() {
  ...
  let currentTimeOld = videoplayer.currentTime;
  $("#video-player").attr("src", $(this).data("url"));
  videoplayer.addEventListener(
    "loadedmetadata",
    function() {
      videoplayer.currentTime = currentTimeOld;
    },
    false
  );
  videoplayer.play();
